...
namespace TaiXiuLiveHit.Tasks
{
    internal static class MoneyHelper
    {
        ...
        public static long CalcAmountMultiChain(long[][] chains, int chainIndex, int levelIndex, bool waitingForWin)
        {
            if (waitingForWin)
                return 0L;
            ...
            bool? win)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        // ?ang ? chu?i cao nh?t m? c?ng thua h?t ? quay v? chu?i 0
                        chainIndex = 0;
                    }
                    levelIndex = 0;
                    profitOnCurrentChain = 0;
