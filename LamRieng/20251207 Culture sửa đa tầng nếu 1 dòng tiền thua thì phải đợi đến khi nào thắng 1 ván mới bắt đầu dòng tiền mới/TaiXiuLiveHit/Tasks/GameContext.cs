...
namespace TaiXiuLiveHit.Tasks
{
    public sealed class GameContext
    {
        ...
        // sau khi thua h?t m?t chu?i -> ??t 0 t?i khi l?i th?ng
        public bool MoneyChainWaitForWin { get; set; } = false;
        // cho Task chen lich su neu stake = 0 (skip bet thuc)
        public Action<string, long>? UiInsertPendingBet;
