...
using static XocDiaSoiLiveKH241.MainWindow;
...
namespace XocDiaSoiLiveKH241
{
    ...
    {
        private const string AppLocalDirName = "XocDiaSoiLiveKH241"; // đổi thành tên bạn muốn
        // ====== App paths ======
...
• Ví dụ: 15 = đặt khi còn ~15% thời gian phiên.";
        ...
        private const string Wv2ZipResNameX64 = "XocDiaSoiLiveKH241.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\XocDiaSoiLiveKH241
...
<body><div class='note'>" + System.Net.WebUtility.HtmlEncode(note) + @"</div></body></html>";
        ...
        private async Task<string> EnsureFixedRuntimePresentAsync()
        {
            ...
            // 1) Runtime riêng của XocDiaSoiLiveKH241 (dùng khi chạy EXE độc lập)
...
";
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                XocDiaSoiLiveKH241.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new XocDiaSoiLiveKH241.Tasks.SeqParityFollowTask(),     // 1
                    1 => new XocDiaSoiLiveKH241.Tasks.PatternParityTask(),       // 2
                    2 => new XocDiaSoiLiveKH241.Tasks.SmartPrevTask(),           // 3
                    3 => new XocDiaSoiLiveKH241.Tasks.RandomParityTask(),        // 4
                    4 => new XocDiaSoiLiveKH241.Tasks.AiStatParityTask(),        // 5
                    5 => new XocDiaSoiLiveKH241.Tasks.StateTransitionBiasTask(), // 6
                    6 => new XocDiaSoiLiveKH241.Tasks.RunLengthBiasTask(),       // 7
                    7 => new XocDiaSoiLiveKH241.Tasks.EnsembleMajorityTask(),    // 8
                    8 => new XocDiaSoiLiveKH241.Tasks.TimeSlicedHedgeTask(),    // 9
                    9 => new XocDiaSoiLiveKH241.Tasks.KnnSubsequenceTask(),     // 10
                    10 => new XocDiaSoiLiveKH241.Tasks.DualScheduleHedgeTask(),  // 11
                    11 => new XocDiaSoiLiveKH241.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 12
                    12 => new XocDiaSoiLiveKH241.Tasks.AiExpertPanelTask(), // 13
                    13 => new XocDiaSoiLiveKH241.Tasks.Top10PatternFollowTask(), // 14
                    _ => new XocDiaSoiLiveKH241.Tasks.SmartPrevTask(),
                };
        ...
        private void StopXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                StopTask();
                XocDiaSoiLiveKH241.Tasks.TaskUtil.ClearBetCooldown();
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project XocDiaSoiLiveKH241)
        ...
        private async Task<string> LoadHomeJsAsync()
        {
            try
            {
                var resName = FindResourceName("js_home_v2.js")
                              ?? "XocDiaSoiLiveKH241.js_home_v2.js"; // fallback tên logic
