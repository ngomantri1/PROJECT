...
namespace XocDiaSoiLiveKH241
{
    ...
    internal static class PackRes
    {
        ...
        public static void EnsureGlobalResourcesLoaded()
        {
            ...
            TryMerge(app.Resources, "pack://application:,,,/XocDiaSoiLiveKH241;component/Assets/Images.xaml");

            // 2. fallback: tự tạo ảnh để dù Images.xaml không load được vẫn không vỡ XAML
            EnsureImage(app.Resources, "ImgLE", "pack://application:,,,/XocDiaSoiLiveKH241;component/Assets/side/LE.png");
            EnsureImage(app.Resources, "ImgCHAN", "pack://application:,,,/XocDiaSoiLiveKH241;component/Assets/side/CHAN.png");
            EnsureImage(app.Resources, "ImgTHANG", "pack://application:,,,/XocDiaSoiLiveKH241;component/Assets/kq/THANG.png");
            EnsureImage(app.Resources, "ImgTHUA", "pack://application:,,,/XocDiaSoiLiveKH241;component/Assets/kq/THUA.png");
