...
using static XocDiaSoiLiveKH241.Tasks.TaskUtil;
...
namespace XocDiaSoiLiveKH241.Tasks
{
    ...
    public sealed class AiOnlineNGramTask : IBetTask
    {
        ...
        private static string AppLocalDir()
            => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "XocDiaSoiLiveKH241", "ai");
