...
using static XocDiaLiveHit2.MainWindow;
using System.Windows.Input;




namespace XocDiaLiveHit2
{
    ...
    {
        private const string AppLocalDirName = "XocDiaLiveHit2"; // đổi thành tên bạn muốn
        // ====== App paths ======
...
• Ví dụ: 15 = đặt khi còn ~15% thời gian phiên.";
        ...
        private const string Wv2ZipResNameX64 = "XocDiaLiveHit2.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\XocDiaLiveHit2
...
<body><div class='note'>" + System.Net.WebUtility.HtmlEncode(note) + @"</div></body></html>";
        ...
        private async Task<string> EnsureFixedRuntimePresentAsync()
        {
            ...
            var resName = FindResourceName("ThirdParty.WebView2Fixed_win-x64.zip")
                          ?? "XocDiaLiveHit2.ThirdParty.WebView2Fixed_win-x64.zip";
...
";
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                XocDiaLiveHit2.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new XocDiaLiveHit2.Tasks.SeqParityFollowTask(),     // 1
                    1 => new XocDiaLiveHit2.Tasks.PatternParityTask(),       // 2
                    2 => new XocDiaLiveHit2.Tasks.SeqMajorMinorTask(),       // 3
                    3 => new XocDiaLiveHit2.Tasks.PatternMajorMinorTask(),   // 4
                    4 => new XocDiaLiveHit2.Tasks.SmartPrevTask(),           // 5
                    5 => new XocDiaLiveHit2.Tasks.RandomParityTask(),        // 6
                    6 => new XocDiaLiveHit2.Tasks.AiStatParityTask(),        // 7
                    7 => new XocDiaLiveHit2.Tasks.StateTransitionBiasTask(), // 8
                    8 => new XocDiaLiveHit2.Tasks.RunLengthBiasTask(),       // 9
                    9 => new XocDiaLiveHit2.Tasks.EnsembleMajorityTask(),    // 10
                    10 => new XocDiaLiveHit2.Tasks.TimeSlicedHedgeTask(),    // 11
                    11 => new XocDiaLiveHit2.Tasks.KnnSubsequenceTask(),     // 12
                    12 => new XocDiaLiveHit2.Tasks.DualScheduleHedgeTask(),  // 13
                    13 => new XocDiaLiveHit2.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 14
                    14 => new XocDiaLiveHit2.Tasks.AiExpertPanelTask(), // 15
                    15 => new XocDiaLiveHit2.Tasks.Top10PatternFollowTask(), // 16
                    _ => new XocDiaLiveHit2.Tasks.SmartPrevTask(),
                };
        ...
        private void StopXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                StopTask();
                XocDiaLiveHit2.Tasks.TaskUtil.ClearBetCooldown();
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project XocDiaLiveHit2)
        ...
        private async Task<string> LoadAppJsAsyncFallback()
        {
            try
            {
                ...
                var resName = FindResourceName("v4_js_xoc_dia_live.js")
                              ?? "XocDiaLiveHit2.v4_js_xoc_dia_live.js";
        ...
        private async Task<string> LoadHomeJsAsync()
        {
            try
            {
                var resName = FindResourceName("js_home_v2.js")
                              ?? "XocDiaLiveHit2.js_home_v2.js"; // fallback tên logic
