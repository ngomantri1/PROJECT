...
using static XocDiaLiveHit3.MainWindow;
using System.Windows.Input;




namespace XocDiaLiveHit3
{
    ...
    {
        private const string AppLocalDirName = "XocDiaLiveHit3"; // đổi thành tên bạn muốn
        // ====== App paths ======
...
• Ví dụ: 15 = đặt khi còn ~15% thời gian phiên.";
        ...
        private const string Wv2ZipResNameX64 = "XocDiaLiveHit3.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\XocDiaLiveHit3
...
<body><div class='note'>" + System.Net.WebUtility.HtmlEncode(note) + @"</div></body></html>";
        ...
        private async Task<string> EnsureFixedRuntimePresentAsync()
        {
            ...
            var resName = FindResourceName("ThirdParty.WebView2Fixed_win-x64.zip")
                          ?? "XocDiaLiveHit3.ThirdParty.WebView2Fixed_win-x64.zip";
...
";
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                XocDiaLiveHit3.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new XocDiaLiveHit3.Tasks.SeqParityFollowTask(),     // 1
                    1 => new XocDiaLiveHit3.Tasks.PatternParityTask(),       // 2
                    2 => new XocDiaLiveHit3.Tasks.SeqMajorMinorTask(),       // 3
                    3 => new XocDiaLiveHit3.Tasks.PatternMajorMinorTask(),   // 4
                    4 => new XocDiaLiveHit3.Tasks.SmartPrevTask(),           // 5
                    5 => new XocDiaLiveHit3.Tasks.RandomParityTask(),        // 6
                    6 => new XocDiaLiveHit3.Tasks.AiStatParityTask(),        // 7
                    7 => new XocDiaLiveHit3.Tasks.StateTransitionBiasTask(), // 8
                    8 => new XocDiaLiveHit3.Tasks.RunLengthBiasTask(),       // 9
                    9 => new XocDiaLiveHit3.Tasks.EnsembleMajorityTask(),    // 10
                    10 => new XocDiaLiveHit3.Tasks.TimeSlicedHedgeTask(),    // 11
                    11 => new XocDiaLiveHit3.Tasks.KnnSubsequenceTask(),     // 12
                    12 => new XocDiaLiveHit3.Tasks.DualScheduleHedgeTask(),  // 13
                    13 => new XocDiaLiveHit3.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 14
                    14 => new XocDiaLiveHit3.Tasks.AiExpertPanelTask(), // 15
                    15 => new XocDiaLiveHit3.Tasks.Top10PatternFollowTask(), // 16
                    _ => new XocDiaLiveHit3.Tasks.SmartPrevTask(),
                };
        ...
        private void StopXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                StopTask();
                XocDiaLiveHit3.Tasks.TaskUtil.ClearBetCooldown();
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project XocDiaLiveHit3)
        ...
        private async Task<string> LoadAppJsAsyncFallback()
        {
            try
            {
                ...
                var resName = FindResourceName("v4_js_xoc_dia_live.js")
                              ?? "XocDiaLiveHit3.v4_js_xoc_dia_live.js";
        ...
        private async Task<string> LoadHomeJsAsync()
        {
            try
            {
                var resName = FindResourceName("js_home_v2.js")
                              ?? "XocDiaLiveHit3.js_home_v2.js"; // fallback tên logic
