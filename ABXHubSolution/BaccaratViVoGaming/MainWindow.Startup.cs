// BaccaratViVoGaming/MainWindow.Startup.cs
using System.IO;
...
namespace BaccaratViVoGaming
{
    ...
    {
        /// <summary>
        /// Chạy đúng nghiệp vụ: load config -> init WebView -> navigate -> apply background.
        ...
        public async Task RunStartupAsync(IGameHostContext? host)
        {
            ...
            // 6) nếu Hub có Web thì map thư mục web cạnh DLL
            if (host?.Web != null)
            {
                try
                {
