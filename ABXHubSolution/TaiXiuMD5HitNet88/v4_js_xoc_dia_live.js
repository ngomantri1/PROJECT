...
(function () {
    ...
    window.readTotalsSafe = function () {
        try {
            ...
            var TX_TOTAL_TAIL = 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/nodeFont/lbTotal';
    ...
    function readSessionSafe() {
        try {
            var TAIL = 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/nodeFont/lbSesionId';
            var txt = '';
    ...
    function readUsernameInfo() {
        ...
        try {
            var node = findByTail('MiniGameScene/Canvas/FootterRoomUi/Left/buttonName/NameUser');
    ...
    var TX_TAIL_BTN_TAI = 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/nodeSkeleton/btnCuocTai';
    var TX_TAIL_BTN_XIU = 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/nodeSkeleton/btnCuocXiu';
    ...
    var TX_MENU_CHIP_CONFIG = [{
            amount: 20000000,
            tailEnd: 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/menuMoney/btnPrices/Btn20M'
        }, {
            amount: 5000000,
            tailEnd: 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/menuMoney/btnPrices/btn5M'
        }, {
            amount: 1000000,
            tailEnd: 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/menuMoney/btnPrices/btn1M'
        }, {
            amount: 500000,
            tailEnd: 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/menuMoney/btnPrices/btn500K'
        }, {
            amount: 100000,
            tailEnd: 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/menuMoney/btnPrices/btn100K'
        }, {
            amount: 50000,
            tailEnd: 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/menuMoney/btnPrices/btn50k'
        }, {
            amount: 10000,
            tailEnd: 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/menuMoney/btnPrices/btn10k'
        }, {
            amount: 1000,
            tailEnd: 'MiniGameScene/MiniGameNode/TopUI/TaiXiuMD5/Main/borderTabble/menuMoney/btnPrices/btn1K'
        }
    ];
    var TX_BET_DELAY = {
    ...
    function txClickSide(side) {
        ...
        var n = txFindNodeByTailEnd(isTai ? TX_TAIL_BTN_TAI : TX_TAIL_BTN_XIU);
        if (!n) {
