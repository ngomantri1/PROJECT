...
using static TaiXiuMD5HitNet88.Tasks.TaskUtil;
...
namespace TaiXiuMD5HitNet88.Tasks
{
    ...
    /// - Quản lý vốn: MoneyManager như các task khác; vào cửa theo số giây còn lại.
    /// </summary>
    public sealed class Top10PatternFollowTask : IBetTask
    {
        ...
        public async Task RunAsync(GameContext ctx, CancellationToken ct)
        {
            ...
            while (true)
            {
                ...
                // Vào cửa theo ngưỡng giây còn lại.
                ...
                if (string.IsNullOrEmpty(curPattern))
                {
                    ...
                    if (string.IsNullOrEmpty(curPattern))
                    {
                        ...
                        await TaskUtil.ApplyPostRoundMoneyAsync(ctx, money, win0, win0 ? stake0 : -stake0, ct);
