...
using static TaiXiuMD5HitNet88.MainWindow;
using System.Windows.Input;




namespace TaiXiuMD5HitNet88
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const string AppLocalDirName = "TaiXiuMD5HitNet88"; // đổi thành tên bạn muốn
        // ====== App paths ======
...
- Cau hinh mac dinh:
  ...
  XIU:1";
        ...
        private record AppConfig
        {
            ...
            public string SideRateText { get; set; } = TaiXiuMD5HitNet88.Tasks.SideRateParser.DefaultText;
        ...
        private sealed class StrategyTabState : INotifyPropertyChanged
        {
            ...
            public TaiXiuMD5HitNet88.Tasks.IBetTask? ActiveTask { get; set; }
            public TaiXiuMD5HitNet88.Tasks.GameContext? RunningContext { get; set; }
        ...
        private const string Wv2ZipResNameX64 = "TaiXiuMD5HitNet88.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\TaiXiuMD5HitNet88
        ...
        private void LoadConfig_Legacy()
        {
            try
            {
                ...
                {
                    var sideTxt = string.IsNullOrWhiteSpace(_cfg.SideRateText) ? TaiXiuMD5HitNet88.Tasks.SideRateParser.DefaultText : _cfg.SideRateText;
                                    ...
                                    if (snap != null)
                                    {
                                        ...
                                        try
                                        {
                                                ...
                                                !string.Equals(seqStr, _baseSeq, StringComparison.Ordinal))
                                            {
                                                ...
                                                {
                                                    if (_activeTask is not TaiXiuMD5HitNet88.Tasks.JackpotMultiSideTask)
                                                    {
...
<body><div class='note'>" + System.Net.WebUtility.HtmlEncode(note) + @"</div></body></html>";
  ...
  try{
    ...
    return 'ok';
        ...
        // 1) Ưu tiên gọi API JS nếu home page có sẵn (__abx_hw_clickPlayXDL),
        ...
        private async Task<bool> OpenXocDiaGameAsync()
        {
            await EnsureWebReadyAsync();
...
";
        ...
        {
            var def = TaiXiuMD5HitNet88.Tasks.SideRateParser.DefaultText;
            if (TxtSideRatio != null)
        ...
        private GameContext BuildContext(StrategyTabState tab, bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                SideRateText = cfg.SideRateText ?? TaiXiuMD5HitNet88.Tasks.SideRateParser.DefaultText,
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                TaiXiuMD5HitNet88.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new TaiXiuMD5HitNet88.Tasks.SeqParityFollowTask(),
                    1 => new TaiXiuMD5HitNet88.Tasks.PatternParityTask(),
                    2 => new TaiXiuMD5HitNet88.Tasks.SeqMajorMinorTask(),
                    3 => new TaiXiuMD5HitNet88.Tasks.PatternMajorMinorTask(),
                    4 => new TaiXiuMD5HitNet88.Tasks.SmartPrevTask(),
                    5 => new TaiXiuMD5HitNet88.Tasks.RandomParityTask(),
                    6 => new TaiXiuMD5HitNet88.Tasks.AiStatParityTask(),
                    7 => new TaiXiuMD5HitNet88.Tasks.StateTransitionBiasTask(),
                    8 => new TaiXiuMD5HitNet88.Tasks.RunLengthBiasTask(),
                    9 => new TaiXiuMD5HitNet88.Tasks.EnsembleMajorityTask(),
                    10 => new TaiXiuMD5HitNet88.Tasks.TimeSlicedHedgeTask(),
                    11 => new TaiXiuMD5HitNet88.Tasks.KnnSubsequenceTask(),
                    12 => new TaiXiuMD5HitNet88.Tasks.DualScheduleHedgeTask(),
                    13 => new TaiXiuMD5HitNet88.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()),
                    14 => new TaiXiuMD5HitNet88.Tasks.AiExpertPanelTask(),
                    15 => new TaiXiuMD5HitNet88.Tasks.Top10PatternFollowTask(),
                    16 => new TaiXiuMD5HitNet88.Tasks.JackpotMultiSideTask(),
                    17 => new TaiXiuMD5HitNet88.Tasks.SmartPrevAdvancedTask(),
                    _ => new TaiXiuMD5HitNet88.Tasks.SmartPrevTask(),
                };
        ...
        private void StopXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsAnyTabRunning())
                {
                    TaiXiuMD5HitNet88.Tasks.TaskUtil.ClearBetCooldown();
                    Log("[Loop] stopped");
                    StopExpiryCountdown();
                    StopLeaseHeartbeat();
        ...
        private GameContext BuildContext_Legacy(bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                MoneyStrategyId = moneyStrategyId,
                SideRateText = _cfg.SideRateText ?? TaiXiuMD5HitNet88.Tasks.SideRateParser.DefaultText,
                UseRawWinAmount = useRawWinAmount,
                BetSeq = _cfg.BetSeq ?? "",
        ...
        private async void PlayXocDia_Click_Legacy(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                TaiXiuMD5HitNet88.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new TaiXiuMD5HitNet88.Tasks.SeqParityFollowTask(),     // 1
                    1 => new TaiXiuMD5HitNet88.Tasks.PatternParityTask(),       // 2
                    2 => new TaiXiuMD5HitNet88.Tasks.SeqMajorMinorTask(),       // 3
                    3 => new TaiXiuMD5HitNet88.Tasks.PatternMajorMinorTask(),   // 4
                    4 => new TaiXiuMD5HitNet88.Tasks.SmartPrevTask(),           // 5
                    5 => new TaiXiuMD5HitNet88.Tasks.RandomParityTask(),        // 6
                    6 => new TaiXiuMD5HitNet88.Tasks.AiStatParityTask(),        // 7
                    7 => new TaiXiuMD5HitNet88.Tasks.StateTransitionBiasTask(), // 8
                    8 => new TaiXiuMD5HitNet88.Tasks.RunLengthBiasTask(),       // 9
                    9 => new TaiXiuMD5HitNet88.Tasks.EnsembleMajorityTask(),    // 10
                    10 => new TaiXiuMD5HitNet88.Tasks.TimeSlicedHedgeTask(),    // 11
                    11 => new TaiXiuMD5HitNet88.Tasks.KnnSubsequenceTask(),     // 12
                    12 => new TaiXiuMD5HitNet88.Tasks.DualScheduleHedgeTask(),  // 13
                    13 => new TaiXiuMD5HitNet88.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 14
                    14 => new TaiXiuMD5HitNet88.Tasks.AiExpertPanelTask(), // 15
                    15 => new TaiXiuMD5HitNet88.Tasks.Top10PatternFollowTask(), // 16
                    16 => new TaiXiuMD5HitNet88.Tasks.JackpotMultiSideTask(), // 17
                    17 => new TaiXiuMD5HitNet88.Tasks.SmartPrevAdvancedTask(), // 18
                    _ => new TaiXiuMD5HitNet88.Tasks.SmartPrevTask(),
                };
                if (_cfg.BetStrategyIndex == 16) useRawWinAmount = true;
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project TaiXiuMD5HitNet88)
        ...
        private async Task<string> LoadAppJsAsyncFallback()
        {
            try
            {
                ...
                var resName = FindResourceName("v4_js_xoc_dia_live.js")
                              ?? "TaiXiuMD5HitNet88.v4_js_xoc_dia_live.js";
...
(function(){
  try{
    ...
    var hasRoot = !!document.getElementById('__cw_root_allin');
            ...
            _ = Task.Run(async () =>
            {
                ...
                try
                {
                    for (int i = 1; i <= 50; i++)
                    {
                        ...
                        string state =
                            $"host={probe.Host} cc={(probe.HasCc ? 1 : 0)} dir={(probe.HasDirector ? 1 : 0)} getScene={(probe.HasGetScene ? 1 : 0)} scene={(probe.HasScene ? 1 : 0)} bet={(probe.HasBet ? 1 : 0)} push={(probe.HasPush ? 1 : 0)} root={(probe.HasRoot ? 1 : 0)} prog={(probe.HasProg ? 1 : 0)} seqLen={probe.SeqLen}";
                        ...
                        var needsPanelReinject = probe.HasCc && probe.HasGetScene && !probe.HasRoot;
                        if (!probe.HasBet || !probe.HasPush || needsPanelReinject)
                        {
                            if (!string.IsNullOrEmpty(_appJs))
                            {
                                try
                                {
                                    ...
                                    LogThrottled("bridge.probe.reinject", $"[BridgeProbe] reinject appJs (try={i}, root={(probe.HasRoot ? 1 : 0)})", 5000);
                                }
                                catch (Exception ex)
                                {
                        ...
                        if (probe.HasBet && probe.HasPush && (!probe.HasCc || probe.HasRoot) && (probe.HasScene || probe.SeqLen > 0 || probe.HasProg))
                        {
    ...
    TextNorm.U(Regex.Replace(raw ?? "", @"[,\s\-]+", "")); // bỏ , khoảng trắng, -
        ...
        private bool ValidateInputsForCurrentStrategy()
        {
            ...
            {
                if (!TaiXiuMD5HitNet88.Tasks.SideRateParser.TryParse(T(TxtSideRatio), out _, out var err))
                {
        ...
        private void SyncStrategyFieldsToUI()
        {
            ...
            if (idx == 16 && TxtSideRatio != null) TxtSideRatio.Text = _cfg.SideRateText ?? TaiXiuMD5HitNet88.Tasks.SideRateParser.DefaultText;
        }
        ...
        private void ShowErrorsForCurrentStrategy()
        {
            ...
            if (idx == 16)
            {
                ...
                bool ok = TaiXiuMD5HitNet88.Tasks.SideRateParser.TryParse(s, out _, out var e3);
