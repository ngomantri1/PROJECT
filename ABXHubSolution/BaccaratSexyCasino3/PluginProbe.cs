    ...
    internal static class PluginProbe
    {
        ...
        internal static void Init()
        {
            try
            {
                ...
                var log = Path.Combine(logDir, "BaccaratSexyCasino3.probe.log");
            ...
            catch (Exception ex)
            {
                try
                {
                    File.AppendAllText(Path.Combine(AppContext.BaseDirectory, "Plugins", "BaccaratSexyCasino3.probe.log"),
