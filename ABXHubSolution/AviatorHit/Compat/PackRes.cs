...
namespace AviatorHit
{
    ...
    internal static class PackRes
    {
        ...
        public static void EnsureGlobalResourcesLoaded()
        {
            ...
            TryMerge(app.Resources, "pack://application:,,,/AviatorHit;component/Assets/Images.xaml");
            ...
            EnsureImage(app.Resources, "ImgBALL0", "pack://application:,,,/AviatorHit;component/Assets/side/TU_TRANG.png");
            EnsureImage(app.Resources, "ImgBALL1", "pack://application:,,,/AviatorHit;component/Assets/side/1TRANG_3DO.png");
            EnsureImage(app.Resources, "ImgBALL2", "pack://application:,,,/AviatorHit;component/Assets/side/SAP_DOI.png");
            EnsureImage(app.Resources, "ImgBALL3", "pack://application:,,,/AviatorHit;component/Assets/side/1DO_3TRANG.png");
            EnsureImage(app.Resources, "ImgBALL4", "pack://application:,,,/AviatorHit;component/Assets/side/TU_DO.png");
