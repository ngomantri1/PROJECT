...
using static TaiXiuThuongHit.MainWindow;
using System.Windows.Input;




namespace TaiXiuThuongHit
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const string AppLocalDirName = "TaiXiuThuongHit"; // đổi thành tên bạn muốn
        // ====== App paths ======
...
- Cau hinh mac dinh:
  ...
  XIU:1";
        ...
        private record AppConfig
        {
            ...
            public string SideRateText { get; set; } = TaiXiuThuongHit.Tasks.SideRateParser.DefaultText;
        ...
        private sealed class StrategyTabState : INotifyPropertyChanged
        {
            ...
            public TaiXiuThuongHit.Tasks.IBetTask? ActiveTask { get; set; }
            public TaiXiuThuongHit.Tasks.GameContext? RunningContext { get; set; }
        ...
        private const string Wv2ZipResNameX64 = "TaiXiuThuongHit.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\TaiXiuThuongHit
        ...
        private void LoadConfig_Legacy()
        {
            try
            {
                ...
                {
                    var sideTxt = string.IsNullOrWhiteSpace(_cfg.SideRateText) ? TaiXiuThuongHit.Tasks.SideRateParser.DefaultText : _cfg.SideRateText;
                                    ...
                                    if (snap != null)
                                    {
                                        ...
                                        try
                                        {
                                                ...
                                                !string.Equals(seqStr, _baseSeq, StringComparison.Ordinal))
                                            {
                                                ...
                                                {
                                                    if (_activeTask is not TaiXiuThuongHit.Tasks.JackpotMultiSideTask)
                                                    {
...
";
        ...
        {
            var def = TaiXiuThuongHit.Tasks.SideRateParser.DefaultText;
            if (TxtSideRatio != null)
        ...
        private GameContext BuildContext(StrategyTabState tab, bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                SideRateText = cfg.SideRateText ?? TaiXiuThuongHit.Tasks.SideRateParser.DefaultText,
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                TaiXiuThuongHit.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new TaiXiuThuongHit.Tasks.SeqParityFollowTask(),
                    1 => new TaiXiuThuongHit.Tasks.PatternParityTask(),
                    2 => new TaiXiuThuongHit.Tasks.SeqMajorMinorTask(),
                    3 => new TaiXiuThuongHit.Tasks.PatternMajorMinorTask(),
                    4 => new TaiXiuThuongHit.Tasks.SmartPrevTask(),
                    5 => new TaiXiuThuongHit.Tasks.RandomParityTask(),
                    6 => new TaiXiuThuongHit.Tasks.AiStatParityTask(),
                    7 => new TaiXiuThuongHit.Tasks.StateTransitionBiasTask(),
                    8 => new TaiXiuThuongHit.Tasks.RunLengthBiasTask(),
                    9 => new TaiXiuThuongHit.Tasks.EnsembleMajorityTask(),
                    10 => new TaiXiuThuongHit.Tasks.TimeSlicedHedgeTask(),
                    11 => new TaiXiuThuongHit.Tasks.KnnSubsequenceTask(),
                    12 => new TaiXiuThuongHit.Tasks.DualScheduleHedgeTask(),
                    13 => new TaiXiuThuongHit.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()),
                    14 => new TaiXiuThuongHit.Tasks.AiExpertPanelTask(),
                    15 => new TaiXiuThuongHit.Tasks.Top10PatternFollowTask(),
                    16 => new TaiXiuThuongHit.Tasks.JackpotMultiSideTask(),
                    17 => new TaiXiuThuongHit.Tasks.SmartPrevAdvancedTask(),
                    _ => new TaiXiuThuongHit.Tasks.SmartPrevTask(),
                };
        ...
        private void StopXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsAnyTabRunning())
                {
                    TaiXiuThuongHit.Tasks.TaskUtil.ClearBetCooldown();
                    Log("[Loop] stopped");
                    StopExpiryCountdown();
                    StopLeaseHeartbeat();
        ...
        private GameContext BuildContext_Legacy(bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                MoneyStrategyId = moneyStrategyId,
                SideRateText = _cfg.SideRateText ?? TaiXiuThuongHit.Tasks.SideRateParser.DefaultText,
                UseRawWinAmount = useRawWinAmount,
                BetSeq = _cfg.BetSeq ?? "",
        ...
        private async void PlayXocDia_Click_Legacy(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                TaiXiuThuongHit.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new TaiXiuThuongHit.Tasks.SeqParityFollowTask(),     // 1
                    1 => new TaiXiuThuongHit.Tasks.PatternParityTask(),       // 2
                    2 => new TaiXiuThuongHit.Tasks.SeqMajorMinorTask(),       // 3
                    3 => new TaiXiuThuongHit.Tasks.PatternMajorMinorTask(),   // 4
                    4 => new TaiXiuThuongHit.Tasks.SmartPrevTask(),           // 5
                    5 => new TaiXiuThuongHit.Tasks.RandomParityTask(),        // 6
                    6 => new TaiXiuThuongHit.Tasks.AiStatParityTask(),        // 7
                    7 => new TaiXiuThuongHit.Tasks.StateTransitionBiasTask(), // 8
                    8 => new TaiXiuThuongHit.Tasks.RunLengthBiasTask(),       // 9
                    9 => new TaiXiuThuongHit.Tasks.EnsembleMajorityTask(),    // 10
                    10 => new TaiXiuThuongHit.Tasks.TimeSlicedHedgeTask(),    // 11
                    11 => new TaiXiuThuongHit.Tasks.KnnSubsequenceTask(),     // 12
                    12 => new TaiXiuThuongHit.Tasks.DualScheduleHedgeTask(),  // 13
                    13 => new TaiXiuThuongHit.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 14
                    14 => new TaiXiuThuongHit.Tasks.AiExpertPanelTask(), // 15
                    15 => new TaiXiuThuongHit.Tasks.Top10PatternFollowTask(), // 16
                    16 => new TaiXiuThuongHit.Tasks.JackpotMultiSideTask(), // 17
                    17 => new TaiXiuThuongHit.Tasks.SmartPrevAdvancedTask(), // 18
                    _ => new TaiXiuThuongHit.Tasks.SmartPrevTask(),
                };
                if (_cfg.BetStrategyIndex == 16) useRawWinAmount = true;
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project TaiXiuThuongHit)
        ...
        private async Task<string> LoadAppJsAsyncFallback()
        {
            try
            {
                ...
                var resName = FindResourceName("v4_js_xoc_dia_live.js")
                              ?? "TaiXiuThuongHit.v4_js_xoc_dia_live.js";
  ...
  try{
    ...
    TextNorm.U(Regex.Replace(raw ?? "", @"[,\s\-]+", "")); // bỏ , khoảng trắng, -
        ...
        private bool ValidateInputsForCurrentStrategy()
        {
            ...
            {
                if (!TaiXiuThuongHit.Tasks.SideRateParser.TryParse(T(TxtSideRatio), out _, out var err))
                {
        ...
        private void SyncStrategyFieldsToUI()
        {
            ...
            if (idx == 16 && TxtSideRatio != null) TxtSideRatio.Text = _cfg.SideRateText ?? TaiXiuThuongHit.Tasks.SideRateParser.DefaultText;
        }
        ...
        private void ShowErrorsForCurrentStrategy()
        {
            ...
            if (idx == 16)
            {
                ...
                bool ok = TaiXiuThuongHit.Tasks.SideRateParser.TryParse(s, out _, out var e3);
