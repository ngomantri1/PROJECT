...
namespace BaccaratSexyCasino
{
    ...
    internal static class PackRes
    {
        ...
        public static void EnsureGlobalResourcesLoaded()
        {
            ...
            EnsureImage(app.Resources, "ImgBALL0", "pack://application:,,,/BaccaratSexyCasino;component/Assets/side/TU_TRANG.png");
            EnsureImage(app.Resources, "ImgBALL1", "pack://application:,,,/BaccaratSexyCasino;component/Assets/side/1TRANG_3DO.png");
            EnsureImage(app.Resources, "ImgBALL2", "pack://application:,,,/BaccaratSexyCasino;component/Assets/side/SAP_DOI.png");
            EnsureImage(app.Resources, "ImgBALL3", "pack://application:,,,/BaccaratSexyCasino;component/Assets/side/1DO_3TRANG.png");
            EnsureImage(app.Resources, "ImgBALL4", "pack://application:,,,/BaccaratSexyCasino;component/Assets/side/TU_DO.png");
