...
namespace XocDiaSoiLiveKH24
{
    ...
    internal static class PackRes
    {
        ...
        public static void EnsureGlobalResourcesLoaded()
        {
            ...
            TryMerge(app.Resources, "pack://application:,,,/XocDiaSoiLiveKH24;component/Assets/Images.xaml");

            // 2. fallback: tự tạo ảnh để dù Images.xaml không load được vẫn không vỡ XAML
            EnsureImage(app.Resources, "ImgLE", "pack://application:,,,/XocDiaSoiLiveKH24;component/Assets/side/LE.png");
            EnsureImage(app.Resources, "ImgCHAN", "pack://application:,,,/XocDiaSoiLiveKH24;component/Assets/side/CHAN.png");
            EnsureImage(app.Resources, "ImgTHANG", "pack://application:,,,/XocDiaSoiLiveKH24;component/Assets/kq/THANG.png");
            EnsureImage(app.Resources, "ImgTHUA", "pack://application:,,,/XocDiaSoiLiveKH24;component/Assets/kq/THUA.png");
