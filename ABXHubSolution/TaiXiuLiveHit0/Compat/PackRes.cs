...
namespace TaiXiuLiveHit0
{
    ...
    internal static class PackRes
    {
        ...
        public static void EnsureGlobalResourcesLoaded()
        {
            ...
            TryMerge(app.Resources, "pack://application:,,,/TaiXiuLiveHit0;component/Assets/Images.xaml");

            // 2. fallback: tự tạo ảnh để dù Images.xaml không load được vẫn không vỡ XAML
            EnsureImage(app.Resources, "ImgXIU", "pack://application:,,,/TaiXiuLiveHit0;component/Assets/side/XIU.png");
            EnsureImage(app.Resources, "ImgTAI", "pack://application:,,,/TaiXiuLiveHit0;component/Assets/side/TAI.png");
            EnsureImage(app.Resources, "ImgTHANG", "pack://application:,,,/TaiXiuLiveHit0;component/Assets/kq/THANG.png");
            EnsureImage(app.Resources, "ImgTHUA", "pack://application:,,,/TaiXiuLiveHit0;component/Assets/kq/THUA.png");
