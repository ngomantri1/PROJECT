...
using static TaiXiuLiveHit0.MainWindow;
using System.Windows.Input;




namespace TaiXiuLiveHit0
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const string AppLocalDirName = "TaiXiuLiveHit0"; // đổi thành tên bạn muốn
        // ====== App paths ======
        ...
        private const string DEFAULT_URL = "https://v.hitclub.med/"; // URL mặc định bạn muốn
...
- Cau hinh mac dinh:
  ...
  XIU:1";
        ...
        private record AppConfig
        {
            ...
            public string SideRateText { get; set; } = TaiXiuLiveHit0.Tasks.SideRateParser.DefaultText;
        ...
        private sealed class StrategyTabState : INotifyPropertyChanged
        {
            ...
            public TaiXiuLiveHit0.Tasks.IBetTask? ActiveTask { get; set; }
            public TaiXiuLiveHit0.Tasks.GameContext? RunningContext { get; set; }
        ...
        private const string Wv2ZipResNameX64 = "TaiXiuLiveHit0.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\TaiXiuLiveHit0
        ...
        private void RecomputeUiMode()
        {
            ...
            var recentGame = (DateTime.UtcNow - _lastGameTickUtc) <= GameTickFresh;
            ApplyUiMode(recentGame || GetIsGameByUrlFallback());
        }
        ...
        private void LoadConfig_Legacy()
        {
            try
            {
                ...
                if (CmbBetStrategy != null)
                    CmbBetStrategy.SelectedIndex = (_cfg.BetStrategyIndex >= 0 && _cfg.BetStrategyIndex <= 17) ? _cfg.BetStrategyIndex : 15;
                ...
                {
                    var sideTxt = string.IsNullOrWhiteSpace(_cfg.SideRateText) ? TaiXiuLiveHit0.Tasks.SideRateParser.DefaultText : _cfg.SideRateText;
                                    ...
                                    if (snap != null)
                                    {
                                        ...
                                        try
                                        {
                                                ...
                                                !string.Equals(seqStr, _baseSeq, StringComparison.Ordinal))
                                            {
                                                ...
                                                {
                                                    if (_activeTask is not TaiXiuLiveHit0.Tasks.JackpotMultiSideTask)
                                                    {
...
<body><div class='note'>" + System.Net.WebUtility.HtmlEncode(note) + @"</div></body></html>";
  ...
  try{
    ...
    return 'ok';
        ...
        // Bấm 'Chơi Tài Xỉu Live' từ Home bằng nhánh C# trực tiếp.
        ...
        private void UpdateTooltips()
        {
            ...
            string tip = idx switch
            {
                ...
                17 => "18) Bám cầu trước nâng cao: Giữ lõi chiến lược 5, nhưng luật seg1/seg3 đổi: seg1=1 & seg3=1 thì đảo; seg1=1 & seg3>=2 thì theo; seg1>=2 luôn theo.",
...
";
        ...
        {
            var def = TaiXiuLiveHit0.Tasks.SideRateParser.DefaultText;
            if (TxtSideRatio != null)
        ...
        private GameContext BuildContext(StrategyTabState tab, bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                SideRateText = cfg.SideRateText ?? TaiXiuLiveHit0.Tasks.SideRateParser.DefaultText,
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                TaiXiuLiveHit0.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new TaiXiuLiveHit0.Tasks.SeqParityFollowTask(),
                    1 => new TaiXiuLiveHit0.Tasks.PatternParityTask(),
                    2 => new TaiXiuLiveHit0.Tasks.SeqMajorMinorTask(),
                    3 => new TaiXiuLiveHit0.Tasks.PatternMajorMinorTask(),
                    4 => new TaiXiuLiveHit0.Tasks.SmartPrevTask(),
                    5 => new TaiXiuLiveHit0.Tasks.RandomParityTask(),
                    6 => new TaiXiuLiveHit0.Tasks.AiStatParityTask(),
                    7 => new TaiXiuLiveHit0.Tasks.StateTransitionBiasTask(),
                    8 => new TaiXiuLiveHit0.Tasks.RunLengthBiasTask(),
                    9 => new TaiXiuLiveHit0.Tasks.EnsembleMajorityTask(),
                    10 => new TaiXiuLiveHit0.Tasks.TimeSlicedHedgeTask(),
                    11 => new TaiXiuLiveHit0.Tasks.KnnSubsequenceTask(),
                    12 => new TaiXiuLiveHit0.Tasks.DualScheduleHedgeTask(),
                    13 => new TaiXiuLiveHit0.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()),
                    14 => new TaiXiuLiveHit0.Tasks.AiExpertPanelTask(),
                    15 => new TaiXiuLiveHit0.Tasks.Top10PatternFollowTask(),
                    16 => new TaiXiuLiveHit0.Tasks.JackpotMultiSideTask(),
                    17 => new TaiXiuLiveHit0.Tasks.SmartPrevAdvancedTask(),
                    _ => new TaiXiuLiveHit0.Tasks.SmartPrevTask(),
                };
        ...
        private void StopXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsAnyTabRunning())
                {
                    TaiXiuLiveHit0.Tasks.TaskUtil.ClearBetCooldown();
                    Log("[Loop] stopped");
                    StopExpiryCountdown();
                    StopLeaseHeartbeat();
        ...
        private GameContext BuildContext_Legacy(bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                MoneyStrategyId = moneyStrategyId,
                SideRateText = _cfg.SideRateText ?? TaiXiuLiveHit0.Tasks.SideRateParser.DefaultText,
                UseRawWinAmount = useRawWinAmount,
                BetSeq = _cfg.BetSeq ?? "",
        ...
        private async void PlayXocDia_Click_Legacy(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                TaiXiuLiveHit0.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new TaiXiuLiveHit0.Tasks.SeqParityFollowTask(),     // 1
                    1 => new TaiXiuLiveHit0.Tasks.PatternParityTask(),       // 2
                    2 => new TaiXiuLiveHit0.Tasks.SeqMajorMinorTask(),       // 3
                    3 => new TaiXiuLiveHit0.Tasks.PatternMajorMinorTask(),   // 4
                    4 => new TaiXiuLiveHit0.Tasks.SmartPrevTask(),           // 5
                    5 => new TaiXiuLiveHit0.Tasks.RandomParityTask(),        // 6
                    6 => new TaiXiuLiveHit0.Tasks.AiStatParityTask(),        // 7
                    7 => new TaiXiuLiveHit0.Tasks.StateTransitionBiasTask(), // 8
                    8 => new TaiXiuLiveHit0.Tasks.RunLengthBiasTask(),       // 9
                    9 => new TaiXiuLiveHit0.Tasks.EnsembleMajorityTask(),    // 10
                    10 => new TaiXiuLiveHit0.Tasks.TimeSlicedHedgeTask(),    // 11
                    11 => new TaiXiuLiveHit0.Tasks.KnnSubsequenceTask(),     // 12
                    12 => new TaiXiuLiveHit0.Tasks.DualScheduleHedgeTask(),  // 13
                    13 => new TaiXiuLiveHit0.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 14
                    14 => new TaiXiuLiveHit0.Tasks.AiExpertPanelTask(), // 15
                    15 => new TaiXiuLiveHit0.Tasks.Top10PatternFollowTask(), // 16
                    16 => new TaiXiuLiveHit0.Tasks.JackpotMultiSideTask(), // 17
                    17 => new TaiXiuLiveHit0.Tasks.SmartPrevAdvancedTask(), // 18
                    _ => new TaiXiuLiveHit0.Tasks.SmartPrevTask(),
                };
                if (_cfg.BetStrategyIndex == 16) useRawWinAmount = true;
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project TaiXiuLiveHit0)
        ...
        private async Task<string> LoadAppJsAsyncFallback()
        {
            try
            {
                ...
                var resName = FindResourceName("v4_js_xoc_dia_live.js")
                              ?? "TaiXiuLiveHit0.v4_js_xoc_dia_live.js";
...
(function(){
  try{
    ...
    var hasPanel = !!document.getElementById('__cw_root_allin');
    ...
    return { error: String(e && e.message || e) };
            ...
            return new BridgeProbeState
            {
                ...
                HasPanel = GetBool(root, "hasPanel"),
            ...
            _ = Task.Run(async () =>
            {
                ...
                try
                {
                    for (int i = 1; i <= 50; i++)
                    {
                        ...
                        string state =
                            $"host={probe.Host} cc={(probe.HasCc ? 1 : 0)} dir={(probe.HasDirector ? 1 : 0)} getScene={(probe.HasGetScene ? 1 : 0)} scene={(probe.HasScene ? 1 : 0)} bet={(probe.HasBet ? 1 : 0)} push={(probe.HasPush ? 1 : 0)} panel={(probe.HasPanel ? 1 : 0)} prog={(probe.HasProg ? 1 : 0)} seqLen={probe.SeqLen}";
                        ...
                        if (!probe.HasBet || !probe.HasPush || (probe.HasScene && !probe.HasPanel))
                        {
                        ...
                        if (probe.HasBet && probe.HasPush && probe.HasPanel && (probe.HasScene || probe.SeqLen > 0 || probe.HasProg))
                        {
        ...
        private void CoreWebView2_FrameCreated_Bridge(object? sender, CoreWebView2FrameCreatedEventArgs e)
        {
            try
            {
                ...
                StartFrameBridgeProbe(f, "created");
        ...
        private void Frame_DOMContentLoaded_Bridge(object? sender, CoreWebView2DOMContentLoadedEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(_appJs))
                    _ = f.ExecuteScriptAsync(_appJs);
                _ = f.ExecuteScriptAsync(FRAME_AUTOSTART);
                StartFrameBridgeProbe(f, "domloaded");
        ...
        private void Frame_NavigationCompleted_Bridge(object? sender, CoreWebView2NavigationCompletedEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(_appJs))
                    _ = f.ExecuteScriptAsync(_appJs);
                _ = f.ExecuteScriptAsync(FRAME_AUTOSTART);
                StartFrameBridgeProbe(f, "navcompleted");
        ...
        private void StartFrameBridgeProbe(CoreWebView2Frame frame, string source)
        {
            if (string.IsNullOrEmpty(_appJs)) return;

            _ = Dispatcher.InvokeAsync(async () =>
            {
                try
                {
                    var mark = await frame.ExecuteScriptAsync(@"
(function(){
  try{
    if (window.__cw_frame_probe_running) return 'busy';
    window.__cw_frame_probe_running = 1;
    return 'start';
  }catch(_){ return 'err'; }
})();");
                    if (!string.Equals(mark?.Trim('"'), "start", StringComparison.Ordinal))
                        return;

                    for (int i = 1; i <= 40; i++)
                    {
                        var state = await frame.ExecuteScriptAsync(@"
(function(){
  try{
    var ready = !!(window.cc && window.cc.director && typeof window.cc.director.getScene === 'function');
    var hasBet = (typeof window.__cw_bet === 'function');
    var hasPush = (typeof window.__cw_startPush === 'function');
    var hasPanel = !!document.getElementById('__cw_root_allin');
    return { ready: ready, hasBet: hasBet, hasPush: hasPush, hasPanel: hasPanel };
                        ...
                        var hasBet = root.TryGetProperty("hasBet", out var betEl) && betEl.ValueKind == JsonValueKind.True;
                        var hasPush = root.TryGetProperty("hasPush", out var pushEl) && pushEl.ValueKind == JsonValueKind.True;
                        var hasPanel = root.TryGetProperty("hasPanel", out var panelEl) && panelEl.ValueKind == JsonValueKind.True;

                        if (ready && (!hasBet || !hasPush || !hasPanel))
                        {
                            await frame.ExecuteScriptAsync(_appJs);
                            LogThrottled("bridge.frame.probe.inject", $"[Bridge] Frame probe reinjected appJs ({source}, try={i}).", 5000);
                        }

                        if (hasPush)
                        {
                            await frame.ExecuteScriptAsync("window.__cw_startPush && window.__cw_startPush(240);");
                        }
                ...
                {
                    LogThrottled("bridge.frame.probe.error", "[Bridge] Frame probe error: " + ex.Message, 5000);
                }
                finally
                {
                    try { await frame.ExecuteScriptAsync("try{ window.__cw_frame_probe_running = 0; }catch(_){}"); } catch { }
                }
            });
        }
        ...
        private async Task<bool> EnsureLicenseAsync()
        {
            ...
            if (lic == null)
            {
                MessageBox.Show("Không tìm thấy license trên cho tài khoản này. Hãy liên hệ Telegram: @minoauto để dùng", "Automino",
                    MessageBoxButton.OK, MessageBoxImage.Warning);
                return false;
            }
            if (!DateTimeOffset.TryParse(lic.exp, out var expUtc))
        ...
        private async Task<bool> AcquireLeaseOnceAsync(string username)
        {
            ...
            try
            {
                ...
                var resp = await http.PostAsJsonAsync(
                    $"{LeaseBaseUrl}/acquire/{uname}",
                    new { clientId = _leaseClientId, sessionId = _leaseSessionId, deviceId = _deviceId, appId = AppLocalDirName });
    ...
    TextNorm.U(Regex.Replace(raw ?? "", @"[,\s\-]+", "")); // bỏ , khoảng trắng, -
        ...
        private bool ValidateInputsForCurrentStrategy()
        {
            ...
            {
                if (!TaiXiuLiveHit0.Tasks.SideRateParser.TryParse(T(TxtSideRatio), out _, out var err))
                {
        ...
        private void SyncStrategyFieldsToUI()
        {
            ...
            if (idx == 16 && TxtSideRatio != null) TxtSideRatio.Text = _cfg.SideRateText ?? TaiXiuLiveHit0.Tasks.SideRateParser.DefaultText;
        }
        ...
        private void ShowErrorsForCurrentStrategy()
        {
            ...
            if (idx == 16)
            {
                ...
                bool ok = TaiXiuLiveHit0.Tasks.SideRateParser.TryParse(s, out _, out var e3);
