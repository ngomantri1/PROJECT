// ABX.Hub/Hosting/PluginLoadContext.cs
using System;
using System.IO;
using System.Linq;
...
namespace ABX.Hub.Hosting
{
    ...
    /// - ABX.Core, ABX.Hub.* và các BCL: dùng chung Default context để tránh lệch type.
    /// </summary>
    public sealed class PluginLoadContext : AssemblyLoadContext, IDisposable
    {
            ...
            : base(isCollectible: true)
        {
            ...
            Resolving += (alc, name) =>
            {
                ...
                if (simple == "ABX.Core" || simple.StartsWith("ABX.Hub", StringComparison.OrdinalIgnoreCase))
                {
        ...
        protected override Assembly? Load(AssemblyName assemblyName)
        {
            ...
            // Không được load lại ABX.Core/ABX.Hub.* vào ALC riêng
            if (simple == "ABX.Core" || simple.StartsWith("ABX.Hub", StringComparison.OrdinalIgnoreCase))
            {
