        ...
        private async void InitAsync()
        {
            ...
            else
            {
                ...
                MessageBox.Show(
                    ...
                    "  - Đặt 'ThirdParty\\WebView2Fixed_win-x64.zip' trong project ABX.Hub (đúng tên file)\n" +
                    "  - Chạy lại để ZIP tự bung vào bin/ThirdParty.\n\n" +
                    "Cách 2: Cài WebView2 Runtime (Evergreen) vào Windows.",
                    "ABX.Hub", MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            if (!ok)
            {
                ...
                MessageBox.Show("Không khởi tạo được WebView2 (đã thử mọi phương án).", "ABX.Hub",
