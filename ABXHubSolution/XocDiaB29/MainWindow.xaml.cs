...
using static XocDiaB29.MainWindow;
...
namespace XocDiaB29
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const string AppLocalDirName = "XocDiaB29"; // đổi thành tên bạn muốn
        // ====== App paths ======
...
- Có thể nhập một phần danh sách (ví dụ chỉ 4DO/4TRANG hoặc SAPDOI/CHAN/LE).";
        ...
        private record AppConfig
        {
            ...
            public string SideRateText { get; set; } = XocDiaB29.Tasks.SideRateParser.DefaultText;
        ...
        private sealed class StrategyTabState : INotifyPropertyChanged
        {
            ...
            public XocDiaB29.Tasks.IBetTask? ActiveTask { get; set; }
        ...
        private const string Wv2ZipResNameX64 = "XocDiaB29.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\XocDiaB29
            ...
            try
            {
                ...
                if (TxtSideRatio != null)
                {
                    var sideTxt = string.IsNullOrWhiteSpace(_cfg.SideRateText)
                        ? XocDiaB29.Tasks.SideRateParser.DefaultText
                        : _cfg.SideRateText;
        ...
        {
            return _strategyTabs.Any(t => t.IsRunning && t.ActiveTask is XocDiaB29.Tasks.JackpotMultiSideTask);
        }
  ...
  try{
    ...
    return 'ok';
        ...
        async void CmbMoneyStrategy_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (!IsAnyTabRunning() || IsActiveTabRunning())
                XocDiaB29.Tasks.MoneyHelper.ResetTempProfitForWinUpLoseKeep();
...
";
        ...
        {
            var def = XocDiaB29.Tasks.SideRateParser.DefaultText;
            if (TxtSideRatio != null)
        ...
        private GameContext BuildContext(StrategyTabState tab, bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                SideRateText = cfg.SideRateText ?? XocDiaB29.Tasks.SideRateParser.DefaultText,
        ...
        {
            StopAllTasks();
            XocDiaB29.Tasks.TaskUtil.ClearBetCooldown();
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                XocDiaB29.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new XocDiaB29.Tasks.SeqParityFollowTask(),     // 1
                    1 => new XocDiaB29.Tasks.PatternParityTask(),       // 2
                    2 => new XocDiaB29.Tasks.SeqMajorMinorTask(),       // 3
                    3 => new XocDiaB29.Tasks.PatternMajorMinorTask(),   // 4
                    4 => new XocDiaB29.Tasks.SmartPrevTask(),           // 5
                    5 => new XocDiaB29.Tasks.RandomParityTask(),        // 6
                    6 => new XocDiaB29.Tasks.AiStatParityTask(),        // 7
                    7 => new XocDiaB29.Tasks.StateTransitionBiasTask(), // 8
                    8 => new XocDiaB29.Tasks.RunLengthBiasTask(),       // 9
                    9 => new XocDiaB29.Tasks.EnsembleMajorityTask(),    // 10
                    10 => new XocDiaB29.Tasks.TimeSlicedHedgeTask(),    // 11
                    11 => new XocDiaB29.Tasks.KnnSubsequenceTask(),     // 12
                    12 => new XocDiaB29.Tasks.DualScheduleHedgeTask(),  // 13
                    13 => new XocDiaB29.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 14
                    14 => new XocDiaB29.Tasks.AiExpertPanelTask(), // 15
                    15 => new XocDiaB29.Tasks.Top10PatternFollowTask(), // 16
                    16 => new XocDiaB29.Tasks.JackpotMultiSideTask(), // 17
                    17 => new XocDiaB29.Tasks.SeqParityHotBackTask(), // 18
                    _ => new XocDiaB29.Tasks.SmartPrevTask(),
                };
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project XocDiaB29)
        ...
        private void UpdateTabWin(StrategyTabState tab, double net, string moneyStrategyId)
        {
            ...
            try
            {
                XocDiaB29.Tasks.MoneyHelper.NotifyTempProfit(moneyStrategyId, net);
            }
            catch { /* ignore */ }
        ...
        private async Task<string> LoadAppJsAsyncFallback()
        {
            try
            {
                ...
                var resName = FindResourceName("v4_js_xoc_dia_live.js")
                              ?? "XocDiaB29.v4_js_xoc_dia_live.js";
        ...
        private async Task<string> LoadHomeJsAsync()
        {
            try
            {
                var resName = FindResourceName("js_home_v2.js")
                              ?? "XocDiaB29.js_home_v2.js"; // fallback tên logic
    ...
    TextNorm.U(Regex.Replace(raw ?? "", @"[,\s\-]+", "")); // bỏ , khoảng trắng, -
        ...
        private bool ValidateInputsForCurrentStrategy()
        {
            ...
            {
                if (!XocDiaB29.Tasks.SideRateParser.TryParse(T(TxtSideRatio), out _, out var err))
                {
        ...
        private void SyncStrategyFieldsToUI()
        {
            ...
            if (idx == 16 && TxtSideRatio != null) TxtSideRatio.Text = _cfg.SideRateText ?? XocDiaB29.Tasks.SideRateParser.DefaultText;
        }
        ...
        private void ShowErrorsForCurrentStrategy()
        {
            ...
            if (idx == 16)
            {
                ...
                bool ok = XocDiaB29.Tasks.SideRateParser.TryParse(s, out _, out var e3);
