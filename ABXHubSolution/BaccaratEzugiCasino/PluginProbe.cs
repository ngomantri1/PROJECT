    ...
    internal static class PluginProbe
    {
        ...
        internal static void Init()
        {
            try
            {
                ...
                var log = Path.Combine(logDir, "BaccaratEzugiCasino.probe.log");
            ...
            catch (Exception ex)
            {
                try
                {
                    File.AppendAllText(Path.Combine(AppContext.BaseDirectory, "Plugins", "BaccaratEzugiCasino.probe.log"),
