...
namespace BaccaratWM
{
    ...
    internal static class PackRes
    {
        ...
        public static void EnsureGlobalResourcesLoaded()
        {
            ...
            TryMerge(app.Resources, "pack://application:,,,/BaccaratWM;component/Assets/Images.xaml");

            // 2. fallback: tự tạo ảnh để dù Images.xaml không load được vẫn không vỡ XAML
            EnsureImage(app.Resources, "ImgBanker", "pack://application:,,,/BaccaratWM;component/Assets/side/BANKER.png");
            EnsureImage(app.Resources, "ImgPlayer", "pack://application:,,,/BaccaratWM;component/Assets/side/PLAYER.png");
            EnsureImage(app.Resources, "ImgTie", "pack://application:,,,/BaccaratWM;component/Assets/side/HOA.png");
            EnsureImage(app.Resources, "ImgTHANG", "pack://application:,,,/BaccaratWM;component/Assets/kq/THANG.png");
            EnsureImage(app.Resources, "ImgTHUA", "pack://application:,,,/BaccaratWM;component/Assets/kq/THUA.png");
            EnsureImage(app.Resources, "ImgHOA", "pack://application:,,,/BaccaratWM;component/Assets/kq/HOA.png");
