...
using static XocDiaTuLinhHit.MainWindow;
using System.Windows.Input;




namespace XocDiaTuLinhHit
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const string AppLocalDirName = "XocDiaTuLinhHit"; // đổi thành tên bạn muốn
        // ====== App paths ======
        ...
        private XocDiaTuLinhHit.Tasks.GameContext? _runningLegacyContext;
        ...
        private const string DEFAULT_URL = "https://v.hitclub.yoga/"; // URL game chuẩn từ DevTools
...
- Có thể nhập một phần danh sách (ví dụ chỉ 4DO/4TRANG hoặc SAPDOI/CHAN/LE).";
        ...
        private record AppConfig
        {
            ...
            public string SideRateText { get; set; } = XocDiaTuLinhHit.Tasks.SideRateParser.DefaultText;
        ...
        private sealed class StrategyTabState : INotifyPropertyChanged
        {
            ...
            public XocDiaTuLinhHit.Tasks.IBetTask? ActiveTask { get; set; }
            public XocDiaTuLinhHit.Tasks.GameContext? RunningContext { get; set; }
        ...
        private const string Wv2ZipResNameX64 = "XocDiaTuLinhHit.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\XocDiaTuLinhHit
        ...
        private static bool IsGameUrlLike(string? url)
        {
            try
            {
                ...
                // DevTools hiện tại: https://v.hitclub.yoga/
                if (host.Equals("v.hitclub.yoga", StringComparison.OrdinalIgnoreCase))
                    return true;
        ...
        private void LoadConfig_Legacy()
        {
            try
            {
                ...
                {
                    var sideTxt = string.IsNullOrWhiteSpace(_cfg.SideRateText) ? XocDiaTuLinhHit.Tasks.SideRateParser.DefaultText : _cfg.SideRateText;
                                        ...
                                        try
                                        {
                                                ...
                                                !string.Equals(seqStr, _baseSeq, StringComparison.Ordinal))
                                            {
                                                ...
                                                if (_pendingRows.Count > 0 && accNow2.HasValue)
                                                {
                                                    ...
                                                    if (_activeTask is not XocDiaTuLinhHit.Tasks.JackpotMultiSideTask)
                                                    {
  ...
  try{
    ...
    return 'ok';
        ...
        async void CmbMoneyStrategy_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (!_uiReady || _tabSwitching) return;
            _cfg.MoneyStrategy = GetMoneyStrategyFromUI();
            XocDiaTuLinhHit.Tasks.MoneyHelper.ResetTempProfitForWinUpLoseKeep();
...
";
        ...
        {
            var def = XocDiaTuLinhHit.Tasks.SideRateParser.DefaultText;
            if (TxtSideRatio != null)
        ...
        private GameContext BuildContext(StrategyTabState tab, bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                SideRateText = cfg.SideRateText ?? XocDiaTuLinhHit.Tasks.SideRateParser.DefaultText,
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                XocDiaTuLinhHit.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new XocDiaTuLinhHit.Tasks.SeqParityFollowTask(),
                    1 => new XocDiaTuLinhHit.Tasks.PatternParityTask(),
                    2 => new XocDiaTuLinhHit.Tasks.SeqMajorMinorTask(),
                    3 => new XocDiaTuLinhHit.Tasks.PatternMajorMinorTask(),
                    4 => new XocDiaTuLinhHit.Tasks.SmartPrevTask(),
                    5 => new XocDiaTuLinhHit.Tasks.RandomParityTask(),
                    6 => new XocDiaTuLinhHit.Tasks.AiStatParityTask(),
                    7 => new XocDiaTuLinhHit.Tasks.StateTransitionBiasTask(),
                    8 => new XocDiaTuLinhHit.Tasks.RunLengthBiasTask(),
                    9 => new XocDiaTuLinhHit.Tasks.EnsembleMajorityTask(),
                    10 => new XocDiaTuLinhHit.Tasks.TimeSlicedHedgeTask(),
                    11 => new XocDiaTuLinhHit.Tasks.KnnSubsequenceTask(),
                    12 => new XocDiaTuLinhHit.Tasks.DualScheduleHedgeTask(),
                    13 => new XocDiaTuLinhHit.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()),
                    14 => new XocDiaTuLinhHit.Tasks.AiExpertPanelTask(),
                    15 => new XocDiaTuLinhHit.Tasks.Top10PatternFollowTask(),
                    16 => new XocDiaTuLinhHit.Tasks.JackpotMultiSideTask(),
                    _ => new XocDiaTuLinhHit.Tasks.SmartPrevTask(),
                };
        ...
        private void StopXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsAnyTabRunning())
                {
                    XocDiaTuLinhHit.Tasks.TaskUtil.ClearBetCooldown();
                    Log("[Loop] stopped");
                    StopExpiryCountdown();
                    StopLeaseHeartbeat();
        ...
        private GameContext BuildContext_Legacy(bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                SideRateText = _cfg.SideRateText ?? XocDiaTuLinhHit.Tasks.SideRateParser.DefaultText,
                UseRawWinAmount = useRawWinAmount,
                BetSeq = _cfg.BetSeq ?? "",
                ...
                UiAddWin = delta =>
                {
                    void Apply()
                    {
                        ...
                        try
                        {
                            XocDiaTuLinhHit.Tasks.MoneyHelper.NotifyTempProfit(moneyStrategyId, net);
                        }
                        catch { /* ignore */ }
        ...
        private async void PlayXocDia_Click_Legacy(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                XocDiaTuLinhHit.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new XocDiaTuLinhHit.Tasks.SeqParityFollowTask(),     // 1
                    1 => new XocDiaTuLinhHit.Tasks.PatternParityTask(),       // 2
                    2 => new XocDiaTuLinhHit.Tasks.SeqMajorMinorTask(),       // 3
                    3 => new XocDiaTuLinhHit.Tasks.PatternMajorMinorTask(),   // 4
                    4 => new XocDiaTuLinhHit.Tasks.SmartPrevTask(),           // 5
                    5 => new XocDiaTuLinhHit.Tasks.RandomParityTask(),        // 6
                    6 => new XocDiaTuLinhHit.Tasks.AiStatParityTask(),        // 7
                    7 => new XocDiaTuLinhHit.Tasks.StateTransitionBiasTask(), // 8
                    8 => new XocDiaTuLinhHit.Tasks.RunLengthBiasTask(),       // 9
                    9 => new XocDiaTuLinhHit.Tasks.EnsembleMajorityTask(),    // 10
                    10 => new XocDiaTuLinhHit.Tasks.TimeSlicedHedgeTask(),    // 11
                    11 => new XocDiaTuLinhHit.Tasks.KnnSubsequenceTask(),     // 12
                    12 => new XocDiaTuLinhHit.Tasks.DualScheduleHedgeTask(),  // 13
                    13 => new XocDiaTuLinhHit.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 14
                    14 => new XocDiaTuLinhHit.Tasks.AiExpertPanelTask(), // 15
                    15 => new XocDiaTuLinhHit.Tasks.Top10PatternFollowTask(), // 16
                    16 => new XocDiaTuLinhHit.Tasks.JackpotMultiSideTask(), // 17
                    _ => new XocDiaTuLinhHit.Tasks.SmartPrevTask(),
                };
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project XocDiaTuLinhHit)
        ...
        private async Task<string> LoadAppJsAsyncFallback()
        {
            try
            {
                ...
                var resName = FindResourceName("v4_js_xoc_dia_live.js")
                              ?? "XocDiaTuLinhHit.v4_js_xoc_dia_live.js";
    ...
    TextNorm.U(Regex.Replace(raw ?? "", @"[,\s\-]+", "")); // bỏ , khoảng trắng, -
        ...
        private bool ValidateInputsForCurrentStrategy()
        {
            ...
            {
                if (!XocDiaTuLinhHit.Tasks.SideRateParser.TryParse(T(TxtSideRatio), out _, out var err))
                {
        ...
        private void SyncStrategyFieldsToUI()
        {
            ...
            if (idx == 16 && TxtSideRatio != null) TxtSideRatio.Text = _cfg.SideRateText ?? XocDiaTuLinhHit.Tasks.SideRateParser.DefaultText;
        }
        ...
        private void ShowErrorsForCurrentStrategy()
        {
            ...
            if (idx == 16)
            {
                ...
                bool ok = XocDiaTuLinhHit.Tasks.SideRateParser.TryParse(s, out _, out var e3);
