...
";
        ...
        private GameContext BuildContext(StrategyTabState tab, bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                SideRateText = cfg.SideRateText ?? XocDiaLiveHit.Tasks.SideRateParser.DefaultText,
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    0 => new XocDiaLiveHit.Tasks.SeqParityFollowTask(),
                    1 => new XocDiaLiveHit.Tasks.PatternParityTask(),
                    2 => new XocDiaLiveHit.Tasks.SeqMajorMinorTask(),
                    3 => new XocDiaLiveHit.Tasks.PatternMajorMinorTask(),
                    4 => new XocDiaLiveHit.Tasks.SmartPrevTask(),
                    5 => new XocDiaLiveHit.Tasks.RandomParityTask(),
                    6 => new XocDiaLiveHit.Tasks.AiStatParityTask(),
                    7 => new XocDiaLiveHit.Tasks.StateTransitionBiasTask(),
                    8 => new XocDiaLiveHit.Tasks.RunLengthBiasTask(),
                    9 => new XocDiaLiveHit.Tasks.EnsembleMajorityTask(),
                    10 => new XocDiaLiveHit.Tasks.TimeSlicedHedgeTask(),
                    11 => new XocDiaLiveHit.Tasks.KnnSubsequenceTask(),
                    12 => new XocDiaLiveHit.Tasks.DualScheduleHedgeTask(),
                    13 => new XocDiaLiveHit.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()),
                    14 => new XocDiaLiveHit.Tasks.AiExpertPanelTask(),
                    15 => new XocDiaLiveHit.Tasks.Top10PatternFollowTask(),
                    16 => new XocDiaLiveHit.Tasks.JackpotMultiSideTask(),
