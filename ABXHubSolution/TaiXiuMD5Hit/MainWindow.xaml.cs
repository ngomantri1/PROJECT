...
using static TaiXiuMD5Hit.MainWindow;
using System.Windows.Input;




namespace TaiXiuMD5Hit
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const string AppLocalDirName = "TaiXiuMD5Hit"; // đổi thành tên bạn muốn
        // ====== App paths ======
...
- Cau hinh mac dinh:
  ...
  XIU:1";
        ...
        private record AppConfig
        {
            ...
            public string SideRateText { get; set; } = TaiXiuMD5Hit.Tasks.SideRateParser.DefaultText;
        ...
        private sealed class StrategyTabState : INotifyPropertyChanged
        {
            ...
            public TaiXiuMD5Hit.Tasks.IBetTask? ActiveTask { get; set; }
            public TaiXiuMD5Hit.Tasks.GameContext? RunningContext { get; set; }
        ...
        private const string Wv2ZipResNameX64 = "TaiXiuMD5Hit.ThirdParty.WebView2Fixed_win-x64.zip";
  ...
  try{
    ...
    (function tick(){
      ...
      setTimeout(tick, delay);
        ...
        {
            // _appDataDir bạn đã tạo ở Startup: %LOCALAPPDATA%\TaiXiuMD5Hit
        ...
        private void LoadConfig_Legacy()
        {
            try
            {
                ...
                {
                    var sideTxt = string.IsNullOrWhiteSpace(_cfg.SideRateText) ? TaiXiuMD5Hit.Tasks.SideRateParser.DefaultText : _cfg.SideRateText;
                                    ...
                                    if (snap != null)
                                    {
                                        ...
                                        try
                                        {
                                                ...
                                                !string.Equals(seqStr, _baseSeq, StringComparison.Ordinal))
                                            {
                                                ...
                                                {
                                                    if (_activeTask is not TaiXiuMD5Hit.Tasks.JackpotMultiSideTask)
                                                    {
...
";
        ...
        {
            var def = TaiXiuMD5Hit.Tasks.SideRateParser.DefaultText;
            if (TxtSideRatio != null)
        ...
        private GameContext BuildContext(StrategyTabState tab, bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                SideRateText = cfg.SideRateText ?? TaiXiuMD5Hit.Tasks.SideRateParser.DefaultText,
        ...
        private async void PlayXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                TaiXiuMD5Hit.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new TaiXiuMD5Hit.Tasks.SeqParityFollowTask(),
                    1 => new TaiXiuMD5Hit.Tasks.PatternParityTask(),
                    2 => new TaiXiuMD5Hit.Tasks.SeqMajorMinorTask(),
                    3 => new TaiXiuMD5Hit.Tasks.PatternMajorMinorTask(),
                    4 => new TaiXiuMD5Hit.Tasks.SmartPrevTask(),
                    5 => new TaiXiuMD5Hit.Tasks.RandomParityTask(),
                    6 => new TaiXiuMD5Hit.Tasks.AiStatParityTask(),
                    7 => new TaiXiuMD5Hit.Tasks.StateTransitionBiasTask(),
                    8 => new TaiXiuMD5Hit.Tasks.RunLengthBiasTask(),
                    9 => new TaiXiuMD5Hit.Tasks.EnsembleMajorityTask(),
                    10 => new TaiXiuMD5Hit.Tasks.TimeSlicedHedgeTask(),
                    11 => new TaiXiuMD5Hit.Tasks.KnnSubsequenceTask(),
                    12 => new TaiXiuMD5Hit.Tasks.DualScheduleHedgeTask(),
                    13 => new TaiXiuMD5Hit.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()),
                    14 => new TaiXiuMD5Hit.Tasks.AiExpertPanelTask(),
                    15 => new TaiXiuMD5Hit.Tasks.Top10PatternFollowTask(),
                    16 => new TaiXiuMD5Hit.Tasks.JackpotMultiSideTask(),
                    17 => new TaiXiuMD5Hit.Tasks.SmartPrevAdvancedTask(),
                    _ => new TaiXiuMD5Hit.Tasks.SmartPrevTask(),
                };
        ...
        private void StopXocDia_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsAnyTabRunning())
                {
                    TaiXiuMD5Hit.Tasks.TaskUtil.ClearBetCooldown();
                    Log("[Loop] stopped");
                    StopExpiryCountdown();
                    StopLeaseHeartbeat();
        ...
        private GameContext BuildContext_Legacy(bool useRawWinAmount = false)
        {
            ...
            return new GameContext
            {
                ...
                MoneyStrategyId = moneyStrategyId,
                SideRateText = _cfg.SideRateText ?? TaiXiuMD5Hit.Tasks.SideRateParser.DefaultText,
                UseRawWinAmount = useRawWinAmount,
                BetSeq = _cfg.BetSeq ?? "",
        ...
        private async void PlayXocDia_Click_Legacy(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                TaiXiuMD5Hit.Tasks.IBetTask task = _cfg.BetStrategyIndex switch
                {
                    0 => new TaiXiuMD5Hit.Tasks.SeqParityFollowTask(),     // 1
                    1 => new TaiXiuMD5Hit.Tasks.PatternParityTask(),       // 2
                    2 => new TaiXiuMD5Hit.Tasks.SeqMajorMinorTask(),       // 3
                    3 => new TaiXiuMD5Hit.Tasks.PatternMajorMinorTask(),   // 4
                    4 => new TaiXiuMD5Hit.Tasks.SmartPrevTask(),           // 5
                    5 => new TaiXiuMD5Hit.Tasks.RandomParityTask(),        // 6
                    6 => new TaiXiuMD5Hit.Tasks.AiStatParityTask(),        // 7
                    7 => new TaiXiuMD5Hit.Tasks.StateTransitionBiasTask(), // 8
                    8 => new TaiXiuMD5Hit.Tasks.RunLengthBiasTask(),       // 9
                    9 => new TaiXiuMD5Hit.Tasks.EnsembleMajorityTask(),    // 10
                    10 => new TaiXiuMD5Hit.Tasks.TimeSlicedHedgeTask(),    // 11
                    11 => new TaiXiuMD5Hit.Tasks.KnnSubsequenceTask(),     // 12
                    12 => new TaiXiuMD5Hit.Tasks.DualScheduleHedgeTask(),  // 13
                    13 => new TaiXiuMD5Hit.Tasks.AiOnlineNGramTask(GetAiNGramStatePath()), // 14
                    14 => new TaiXiuMD5Hit.Tasks.AiExpertPanelTask(), // 15
                    15 => new TaiXiuMD5Hit.Tasks.Top10PatternFollowTask(), // 16
                    16 => new TaiXiuMD5Hit.Tasks.JackpotMultiSideTask(), // 17
                    17 => new TaiXiuMD5Hit.Tasks.SmartPrevAdvancedTask(), // 18
                    _ => new TaiXiuMD5Hit.Tasks.SmartPrevTask(),
                };
                if (_cfg.BetStrategyIndex == 16) useRawWinAmount = true;
  ...
  try{
    ...
    window.__abx_lockMouse = function(on){
      try{ return on ? add() : remove(); } catch(e){ return 'err:'+e; }
        ...
        // đặt trong MainWindow.xaml.cs (project TaiXiuMD5Hit)
        ...
        private async Task<string> LoadAppJsAsyncFallback()
        {
            try
            {
                ...
                var resName = FindResourceName("v4_js_xoc_dia_live.js")
                              ?? "TaiXiuMD5Hit.v4_js_xoc_dia_live.js";
  ...
  try{
    ...
    TextNorm.U(Regex.Replace(raw ?? "", @"[,\s\-]+", "")); // bỏ , khoảng trắng, -
        ...
        private bool ValidateInputsForCurrentStrategy()
        {
            ...
            {
                if (!TaiXiuMD5Hit.Tasks.SideRateParser.TryParse(T(TxtSideRatio), out _, out var err))
                {
        ...
        private void SyncStrategyFieldsToUI()
        {
            ...
            if (idx == 16 && TxtSideRatio != null) TxtSideRatio.Text = _cfg.SideRateText ?? TaiXiuMD5Hit.Tasks.SideRateParser.DefaultText;
        }
        ...
        private void ShowErrorsForCurrentStrategy()
        {
            ...
            if (idx == 16)
            {
                ...
                bool ok = TaiXiuMD5Hit.Tasks.SideRateParser.TryParse(s, out _, out var e3);
