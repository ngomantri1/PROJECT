...
class RiskCode(str, Enum):
    ...
    SAME_ROUND_REENTRY_ALLOWED = "same_round_reentry_allowed"
    SAME_RUN_EPOCH_DUPLICATE = "same_run_epoch_duplicate"
    SIDE_CONFLICT_CALCULATE_ONLY = "side_conflict_calculate_only"
    ATTEMPT_CLICK_IN_PROGRESS = "attempt_click_in_progress"
    ATTEMPT_ASSUMED_PLACED = "attempt_assumed_placed"
    ATTEMPT_CONFIRMED = "attempt_confirmed"
    ATTEMPT_UNCERTAIN = "attempt_uncertain"
    ROUND_EXPOSURE_LIMIT = "round_exposure_limit"
    SHUFFLING = "shuffling"
